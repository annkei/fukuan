...
var PayPalLink  =   "https://linir.cn";
$('#paypal-donate>a').href = PayPalLink;
$('#github-box>a').href = GithubLink;
var qrcodes = {
    'btc_donate'	:	'./imgs/BTCQR.png',	// 二维码路径
    'alipay_donate'	:	'./imgs/AliPayQR.png',	// 支付宝二维码
    'alipay_donate_link'   :   'https://qr.alipay.com/fkx07652iwzqzlempduzdc6',   // 支付宝二维码上的链接，必须换成自己的连接！！！
    'wechat_donate'	:	'./imgs/WeChanSQ.png'
};
